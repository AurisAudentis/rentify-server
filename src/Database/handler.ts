...
import { requestRelationSchema } from "./Models/Request";

export const connectMongo = (app: app) => connect(config.database.url, {useNewUrlParser: true})
    .then(() => createRelations([userRelationSchema, roomRelationSchema, eventRelationSchema, groupRelationSchema, issueRelationSchema, messageRelationSchema, requestRelationSchema]))
